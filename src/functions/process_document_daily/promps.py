...
def generate_prompt():
    return """
        ...
        • Este bloque debe contener todas las combinaciones únicas de aplicación y diaria, con su respectivo costo.
        ...
        • Cada registro debe tener los siguientes campos: application, day y cost, donde cost debe ser expresado con dos decimales en USD.
...

        {
            "costSummary": {
                ...
                "totalCostByDays": [
                 ...
                 "costByApplicationsByDays": [
                        {"application": "", "day": "", "cost": ""}
                ]
            },
